...
| --- | --- | --- |
| [2026-09-22](2026-09-22-live-through-the-crate.md) | Do the crate, the driver and the ledger hold under a real model and router? | Yes. Four runs: the first hunted for a diff, the second pooled all four private facts, the third reached quiescence with queue, hold and a five-hop handoff chain, the fourth ran real conversations and lost its handoffs to a refused in-thread broadcast |
