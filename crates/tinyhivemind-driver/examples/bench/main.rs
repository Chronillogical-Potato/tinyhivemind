...
//!
//! ```sh
//! cargo run --release -p tinyhivemind-driver --example bench
//! cargo run --release -p tinyhivemind-driver --example bench -- --episodes 2000 --members 8
//! ```
//!
...
use tinyhivemind_driver::{
    ...
    DriverState, Error, HiveGraph, HostAction,
};
...
/// nothing in this benchmark boots a runtime -- every arm is a
...
fn hive(ids: &[String]) -> BoundHive<Seat> {
    BoundHive::new(
        HiveGraph::new(
            Desk {
                id: "desk".into(),
