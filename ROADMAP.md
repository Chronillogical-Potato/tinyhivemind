...
| P25 | Typed semantic decisions: fixed-point selector distributions, admission-gated probabilistic quorum, native Jev example integration, and a paired strict-JSON baseline | **done** — see [`docs/specs/jev-integration.md`](docs/specs/jev-integration.md) |
